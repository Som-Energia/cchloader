...
class P1BaseAdapter(Schema):
    ...
    def valid_measure(self, data):
        aoquality = int(data.get('aoquality', 0))
        r1quality = int(data.get('r1quality', 0))
        r2quality = int(data.get('r2quality', 0))
        r3quality = int(data.get('r3quality', 0))
        r4quality = int(data.get('r4quality', 0))
